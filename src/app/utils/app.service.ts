...
export class AppService {
  ...
  getStudentList(obj: any) {
    return this.http.post(this.apiUrl + "StudentRegistration/StudentList", obj, { headers: this.headers })
  }

  saveStudent(obj: any) {
    return this.http.post(this.apiUrl + "StudentRegistration/saveStudent", obj, { headers: this.headers })
  }

  deleteStudent(obj: any) {
    return this.http.post(this.apiUrl + "StudentRegistration/deleteStudent", obj, { headers: this.headers })
  }
  DashboardCount(obj: any) {
    return this.http.post(this.apiUrl + 'StudentRegistration/DashboardCount', obj, { headers: this.headers });
  }
